    ...
    >
      ...
      <!-- 新增 -->
        ...
        <el-form ref="form_2" :model="groupItem" :rules="rules_2"  v-for="(groupItem,groupIndex) in accountChildItem.formList" :key="groupIndex"  style="display: flex;margin-bottom: 40px; align-items: center;">
          ...
          <el-form-item  prop="show_cnt" :rules="{required:true,message:'show_cnt不能为空',trigger:'blur'}" label-position="top" :label="groupIndex==0?'show_cnt':''">
          ...
          <el-form-item  prop="arpu" :rules="{required:true,message:'arpu不能为空',trigger:'blur'}" label-position="top" :label="groupIndex==0?'arpu':''">
