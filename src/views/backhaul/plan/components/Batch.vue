<template>
  ...
  <div class="eldialog">
    <el-dialog :visible.sync="visible" title="批量新增">
      <el-form ref="form">
        <el-form-item :label-width="formLabelWidth" label="上传计划id和概率:" prop="file">
           <div class="uploadDiv">
              <el-upload
                action=""
                accept=".xls,.xlsx"
              ...
              <span style="line-height:14px;display:inline-block;margin-top:20px;">（上传文件表头字段：计划id，概率，转化回传概率；上传数据内容格式示例：1660925180058660，80，90
