    ...
    >
      ...
      <!-- 新增 -->
        ...
        <el-form ref="form_2" :model="groupItem" :rules="rules_2"  v-for="(groupItem,groupIndex) in accountChildItem.formList" :key="groupIndex"  style="display: flex;margin-bottom: 40px; align-items: center;">
          ...
          <!-- 其它 -->
          <el-form-item label-position="top" :label="groupIndex==0?'其它':''">
            <el-select 
            style="width: 120px;margin-left:5px;"
            filterable
            placeholder="请选择"
            v-model="groupItem.other"
            >
              <el-option
          ...
          <!-- click_cnt -->
          <el-form-item  label-position="top" :label="groupIndex==0?'click_cnt符号':''">
            <el-select 
            style="width: 100px;margin-left: 15px;"
            filterable
            placeholder="请选择"
            v-model="groupItem.click_cnt_symbol"
            >
              <el-option
          ...
          <el-form-item  prop="click_cnt" label-position="top" :label="groupIndex==0?'click_cnt':''">
            <el-input v-model="groupItem.click_cnt" style="width: 120px;margin-left: 5px;" placeholder="请输入数字，保留两位小数"></el-input>
          </el-form-item>
          <!-- 自拉起最少次数 -->
          <el-form-item prop="pull_cnt" label-position="top" :label="groupIndex==0?'自拉起最少次数':''">
            <el-input v-model="groupItem.pull_cnt" style="width: 120px;margin-left: 5px;" placeholder="请输入"></el-input>
          </el-form-item>
          <!-- 计算周期 -->
        ...
        <div class="tips">
          ...
          <p>6、【show_cnt】&【click_cnt】至少填写一组：开始时间为新增时间</p>
          <p>7、自拉起最少次数：非必填；不填写时自拉起最少次数默认为0</p>
        </div>
